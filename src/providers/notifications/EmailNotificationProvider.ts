        ...
        return `
            <div style="margin-top: 30px; padding-top: 20px; border-top: 1px solid #ddd; text-align: center; color: #666; font-size: 12px;">
                ...
                <p style="margin: 5px 0;">
                    <a href="https://github.com/deepakkamboj/playwright-smart-reporter" style="color: #1976d2; text-decoration: none;">GitHub</a> |
                    <a href="https://www.npmjs.com/package/playwright-smart-reporter" style="color: #1976d2; text-decoration: none;">npm</a>
                </p>
            </div>
        `;
    }
